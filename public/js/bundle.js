...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoidm9ob2FuZ3RpZW4iLCJhIjoiY2thd212MjJpMDZ0cDJ6bGk3aW1ldng2bSJ9.qhrY84FnqnmQrNiZmSaDbA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/vohoangtien/ckawn1ztl02gp1jpfej66mghh',
    scrollZoom: false
  });
...
exports.updateUserAccount = void 0;
...
var updateUserAccount = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0, _axios.default)({
              url: "http://127.0.0.1:8000/api/v1/users/".concat(type === 'password' ? 'updateMyPassword' : 'updateMe'),
              method: 'PATCH',
              data: data
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Updated your account ".concat(type, " successfully")); //  window.setTimeout((_) => {
              //   location.assign('/me');
              //  }, 1500);
            }
  ...
  return function updateUserAccount(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51GwLqZFXNPheHUOwThtSCsBq1RdAIFDbNkiY3Y6EzBpZ9VgTpqaccoGhv065a3s2GGPwe6TqmWt0nmnWagtvjVSR00BzvBnT4r'); // 1) Get the checkout session from API
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 9;
              return (0, _updateSettings.updateUserAccount)(form, 'userData');
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 7;
              return (0, _updateSettings.updateUserAccount)({
                password: password,
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5751" + '/');
